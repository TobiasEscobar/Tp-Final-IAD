...
carpeta_raiz = "periodos trimestrales/periodo 2018"
...
nombres_trimestres_legibles = {
    "usu_individual_t118.txt": "2018-T1",
    "usu_individual_t218.txt": "2018-T2",
    "usu_individual_t318.txt": "2018-T3",
    "usu_individual_t418.txt": "2018-T4",
}
...
plt.ylabel("Tasa (%)")
plt.title("Evolución de las tasas en la región NEA de 2018")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()